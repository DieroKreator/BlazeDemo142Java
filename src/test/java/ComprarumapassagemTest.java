...
public class ComprarumapassagemTest {
  ...
  public void comprarumapassagem() {
    ...
    assertEquals(driver.findElement(By.cssSelector("h1")).getText(), is("Welcome to the Simple Travel Agency!"));
    ...
    assertEquals(driver.findElement(By.cssSelector("h3")).getText(), is("Flights from Philadelphia to Rome:"));
    driver.findElement(By.cssSelector("tr:nth-child(3) .btn")).click();
    assertEquals(driver.findElement(By.cssSelector("h2")).getText(), is("Your flight from TLV to SFO has been reserved."));
    ...
    driver.findElement(By.cssSelector(".btn-primary")).click();
    assertEquals(driver.findElement(By.cssSelector("h1")).getText(), is("Thank you for your purchase today!"));
    driver.close();
  }
}
